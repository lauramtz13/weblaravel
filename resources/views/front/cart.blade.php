...
<div class="container mt-5 mb-5">
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="3"></td>
                <td class="font-weight-bolder">IMPUESTO 5% </td>
                <td class="font-weight-bolder">USD {{number_format(Cart::getSubTotal()*0.5,2)}}</td>
                <td></td>
            </tr>
            <tr>
                <td colspan="3"></td>
                <td class="font-weight-bolder">TOTAL </td>
                <td class="font-weight-bolder">USD {{number_format(Cart::getTotal()+Cart::getSubTotal()*0.5,2)}}</td>
                <td></td>
            </tr>
        </tbody>
    </table>
